...
class AddToTopMenu implements ObserverInterface
{
    ...
    public function __construct(
        ...
        \Magestore\Auction\Model\Auction $auctionModel
    ) {
        ...
        $this->_auctionModel = $auctionModel;
    }
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        if ($isEnableModule) {
            $auctionData = [
                'name'       => 'Auctions',
                'id'         => 'auction',
                'url'        => $this->_storeManager->getStore()->getUrl('auction'),
                'has_active' => false,
                'is_active'  => false,
            ];
            $parentCategoryNode = $observer->getMenu();
            $tree = $parentCategoryNode->getTree();
            $categoryNode = new \Magento\Framework\Data\Tree\Node($auctionData, 'id', $tree, $parentCategoryNode);
